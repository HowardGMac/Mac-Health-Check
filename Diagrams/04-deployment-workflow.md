...
This diagram provides a step-by-step guide for deploying the `4.0.0b6` release of Mac Health Check through an MDM solution. Follow the phases in order for a successful deployment.
