# Mac Health Check Documentation Diagrams (4.0.0b6.3)

## Overview

This directory contains Mermaid-based diagrams aligned to the `4.0.0b6.3` release of [Mac Health Check](https://snelson.us/mhc). The diagrams render automatically on GitHub and cover the current deployment, runtime, operation-mode, and health-check behavior documented by the script, README, and changelog.
