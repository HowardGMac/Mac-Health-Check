...
This diagram compares all five `4.0.0b7` Mac Health Check operation modes, showing how each mode differs in terms of UI, Dock behavior, logging, and intended use case.
...
| **Fresh-config replay** | Yes when `inspectSummaryPreset="on"` (15-minute cache) | No | No | No | No |
